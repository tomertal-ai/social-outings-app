        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.card} onPress={() => router.push('/parties' as any)}>
            ...
            <View style={styles.cardIcon}>
              <Ionicons name="calendar" size={28} color="#7B61FF" />
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.card} onPress={() => router.push('/clubs' as any)}>
            ...
            <View style={styles.cardIcon}>
              <Ionicons name="musical-notes" size={28} color="#7B61FF" />
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.card} onPress={() => router.push('./my-events' as any)}>
            ...
            <View style={styles.cardIcon}>
              <Ionicons name="checkmark-circle" size={28} color="#7B61FF" />
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.card} onPress={() => router.push('./map' as any)}>
            ...
            <View style={styles.cardIcon}>
              <Ionicons name="map" size={28} color="#7B61FF" />
            </View>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  section: { padding: 20 },
  sectionTitle: { fontSize: 20, fontWeight: 'bold', color: '#ffffff', marginBottom: 15, textAlign: 'right' },
  card: {
    backgroundColor: '#1e1e2e', borderRadius: 16, padding: 20, marginBottom: 14,
  ...
  cardIcon: { backgroundColor: '#2a2a3c', borderRadius: 12, padding: 10, marginLeft: 14 },
  cardTitle: { fontSize: 17, fontWeight: 'bold', color: '#ffffff', marginBottom: 4, textAlign: 'right' },
  cardDescription: { fontSize: 13, color: '#9ca3af', textAlign: 'right' },
  cardContent: { flex: 1 },
  emptyState: {
    backgroundColor: '#1e1e2e', borderRadius: 16, padding: 36, alignItems: 'center',
    shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05,
    shadowRadius: 4, elevation: 1,
  },
  emptyText: { fontSize: 16, fontWeight: '600', color: '#d1d5db', marginTop: 12 },
